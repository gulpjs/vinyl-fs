...
describe('symlink stream', function() {
  ...
  [{
    description: 'should write buffer files to the right folder',
    expectedLink: path.join(__dirname, './fixtures/test.coffee'),
    options: {},
  }, {
    ...
    it(test.description, function(done) {
      ...
      var onEnd = function() {
        ...
        fs.existsSync(expectedPath).should.equal(true);
        bufEqual(fs.readFileSync(expectedPath), expectedContents).should.equal(true);
        fs.readlinkSync(expectedPath).should.equal(test.expectedLink);
        done();
      };

      var stream = vfs.symlink('./out-fixtures/', assign({ cwd: __dirname }, test.options));
  ...
  [{
    description: 'should write directories to the right folder',
    expectedLink: path.join(__dirname, './fixtures/wow'),
    options: {},
  }, {
